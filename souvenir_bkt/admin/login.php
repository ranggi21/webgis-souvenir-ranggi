  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="act/session.php" method="post">
		        <h2 class="form-login-heading" style="background-color:black">LOG IN NOW</h2>
      ...
      <div class="row">
        ...
        <!-- <div class="col-xs-4"> --> 
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit" style="background-color:black">Log In</button>
        </div>
        ...
        <hr>
        <a href="../" class="btn btn-primary btn-block btn-flat" style="background-color:black">Back</a>
      </div>
  <!--   </form> -->
