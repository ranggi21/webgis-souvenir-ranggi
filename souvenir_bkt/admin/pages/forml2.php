		...
		<h4 style="text-transform:capitalize;">Product List</h4>
			<div id="forml">
				<input type="text" class="form-control hidden" id="id" name="id" value="<?php echo $id_small_industry ?>">
					...
					<thead><th>  </th><th>Product</th><th>Price</th></thead>
					<tbody>
					<script>
						function enable(id)
						{
					...
					<tr>
						...
						<?php
							...
							{ ?> <tr> <?php
								$sql3 = mysqli_query($conn,"SELECT * FROM detail_product_small_industry where id_small_industry='$id_small_industry' and id_product=$dt[id]");
