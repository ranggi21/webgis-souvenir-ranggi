...
<div class="col-xs-12">
	<div class="box">
		<div class="box-body">
			...
			?>
				<h4 style="text-transform:capitalize;">Update Data Atribut <?php echo $data['nama_industri'] ?></h4>
				...
				<br><br><br>
					...
					<div class="form-group" style="clear:both">
						<label for="nama">Industry Name</label>
					...
					<div class="form-group">
						<label for="harga">Product Range Price</label>
					...
					<div class="form-group">
						<label for="selectjns">Industry Type</label>
					...
					<div class="form-group">
						<label for="selectstat">Place Status</label>
