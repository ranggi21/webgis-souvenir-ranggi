  ...
  if(pg_query($sql)){
    ...
    }else
    {
      ...
      ?>       
            ...
            <a href="?page=souvenirs<?php echo $id ?>" class="btn btn-primary pull-left"><i class="fa fa-chevron-left"></i> Back</a>    
    <div class="btn-group pull-right">
    <a href="?page=formjnssou" class="btn btn-default">Add <i class="fa fa-plus"></i></a><br><br><br>
    </div>
    </div>
