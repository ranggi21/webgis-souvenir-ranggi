  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg " style="background-color: black">
            ...
            <!--logo start-->
            <a class="logo" ><font face="Courier New">WebGis Souvenir (23 1811522025 Ranggi Aureliyanto Putra)</font> <img src=""></a>
            <!--logo end-->
                ...
                <!-- First Action -->
                      ...
                      <!--custom chart end-->
                          ...
                          <!-- <h3 style="font-size:16px">Angkot Information</h3> -->
                              ...
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                                <div class="form-group" id="tampillistangkotik1" style="display:none;">
                                  <table class="table table-bordered" id='tampillistangkotik' style=""></table>
                                </div>
                              </div>         
                        </div> 
                        <div class="col-lg-5 ds"  id="hasilmosque" style="display:none;">
                          ...
                          <a class="btn btn-compose" style="color: white; background-color: black;">Mosque Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                          ...
                          <!-- <div class="col-md-12 padding-0" style="display:none;"> -->
                          <!-- <h3 style="font-size:16px">Mosque Information</h3> -->
                          <a class="btn btn-compose" style="color: white; background-color: black;">Restaurant Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                        ...
                        <div class="col-lg-5 ds"  id="hasilhotel" style="display:none;">
                          ...
                          <a class="btn btn-compose" style="color: white; background-color: black;">Hotel Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                        ...
                        <div class="col-lg-5 ds"  id="hasilobj" style="display:none;">
                          ...
                          <a class="btn btn-compose" style="color: white; background-color: black;">Tourism Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                        ...
                        <div class="col-lg-5 ds"  id="hasilindustry" style="display:none;">
                          ...
                          <a class="btn btn-compose" style="color: white; background-color: black;">Industry Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                        ...
                        <div class="col-lg-5 ds"  id="hasilsouv" style="display:none;">
                          ...
                          <!-- <h3 style="font-size:16px">Souvenir Information</h3> -->
                           <a class="btn btn-compose" style="color: white; background-color: black;">Souvenir Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
                        ...
                        <div class="col-lg-5 ds"  id="hasilculi" style="display:none;">
                          ...
                          <!-- <h3 style="font-size:16px">Culinary Information</h3> -->
                           <a class="btn btn-compose" style="color: white; background-color: black;">Culinary Information</a>
                              <!-- First Action -->
                              <div class="box-body" style="max-height:450px;overflow-y: scroll;">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div id="nearbyik" class="col-md-4 col-sm-4 mb" style="display:none;">
        ...
        <div class="col-lg-4 ds"  id="hasilrute" style="display:none;">
          ...
          <a class="btn btn-compose" style="color: white; background-color: black;">Rute</a>
              <!-- First Action -->
